...
class Info(models.Model):
    ...
    pubdates = models.CharField(max_length=255, blank=True, null=True)
    durations = models.CharField(max_length=255, blank=True, null=True)
    genres = models.CharField(max_length=4095, blank=True, null=True)
    countries = models.CharField(max_length=255, blank=True, null=True)
    image = models.CharField(max_length=4095, blank=True, null=True)
